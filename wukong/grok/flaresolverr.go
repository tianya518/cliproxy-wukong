...
const (
	...
	defaultClearanceTimeout      = time.Minute
...
func solveFlareSolverr(ctx context.Context, cfg Config, proxyURL string) (clearanceSolution, error) {
	if isTunnelProxy(proxyURL) {
...
func isTunnelProxy(proxyURL string) bool {
