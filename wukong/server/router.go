...
func RegisterArtifactAndAdminRoutes(r gin.IRouter, cfg *ServerConfig, pool *TokenPool, session *SessionManager, grokStore *grok.AccountStore) {
	...
	// Grok Web SSO
	grokH := NewGrokHandler(grokStore)
